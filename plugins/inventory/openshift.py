...
from ansible_collections.ansible.kubernetes.plugins.inventory.k8s import K8sInventoryException, InventoryModule as K8sInventoryModule, format_dynamic_api_exc
...
class InventoryModule(K8sInventoryModule):
    NAME = 'ansible.kubernetes.openshift'
