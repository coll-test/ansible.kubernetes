...
- ansible.kubernetes.k8s_name_options
- ansible.kubernetes.k8s_auth_options
- ansible.kubernetes.k8s_resource_options
- ansible.kubernetes.k8s_scale_options
'''
...
from ansible_collections.ansible.kubernetes.plugins.module_utils.k8s.scale import KubernetesAnsibleScaleModule
