...
from ansible_collections.ansible.kubernetes.plugins.module_utils.k8s.common import AUTH_ARG_SPEC, COMMON_ARG_SPEC
from ansible_collections.ansible.kubernetes.plugins.module_utils.k8s.common import KubernetesAnsibleModule
