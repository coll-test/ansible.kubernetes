...
from ansible_collections.ansible.kubernetes.plugins.module_utils.kubevirt import KubeVirtRawModule
from ansible_collections.ansible.kubernetes.plugins.modules import kubevirt_vm as mymodule
